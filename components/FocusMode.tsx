...
const FocusMode: React.FC<FocusModeProps> = ({ isOpen, onClose, tasks, onUpdateTask }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-[#050505] flex flex-col animate-fade-in text-white overflow-hidden">
            ...
            {/* Early Exit Challenge Modal - Refined Style */}
            {showExitChallenge && (
                <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300">
                    <div className="relative bg-[#121212] border border-white/5 p-8 rounded-[40px] max-w-sm w-full text-center shadow-2xl scale-100 animate-in zip-in duration-300">

                        <h3 className="text-3xl font-black text-white mb-3 tracking-tight pt-4">
                            Leaving so soon?
                        </h3>

                        <p className="text-gray-400 text-base font-medium mb-10 leading-relaxed px-2">
                            "{randomMessage}"
                        </p>
                        ...
                        <div className="flex flex-col gap-3">
                            <button
                                ...
                                className="w-full py-4 bg-primary text-black font-black text-lg rounded-full hover:scale-105 active:scale-95 transition-all shadow-lg hover:shadow-primary/20"
                            >
                                STAY FOCUSED
                            </button>
                            ...
                            <button
                                onClick={onClose}
                                className="w-full py-4 bg-[#1C1C1E] border border-white/5 text-gray-400 font-bold text-lg rounded-full transition-all duration-300 hover:bg-red-500 hover:text-white hover:border-red-500 hover:scale-105 hover:shadow-[0_0_20px_rgba(239,68,68,0.4)] active:scale-95"
                            >
                                Exit Session
                            </button>
                        </div>
